 ...
 */
@Deprecated
public class SpanChunkBoMapper implements ThriftBoMapper<SpanBo, TFSpanChunk> {

    @Override
    public SpanBo map(TFSpanChunk thriftObject) {
        SpanBo tfSpan = new SpanBo();
        tfSpan.setVersion(thriftObject.getVersion());
        tfSpan.setCollectorAcceptTime(thriftObject.getKeyTime());
...
//        tfSpan.setTransactionId(thriftObject.getTransactionId());
        tfSpan.setSpanId(thriftObject.getSpanId());
        tfSpan.setEndPoint(thriftObject.getEndPoint());
//        tfSpan.setServiceType(thriftObject.getApplicationServiceType());
