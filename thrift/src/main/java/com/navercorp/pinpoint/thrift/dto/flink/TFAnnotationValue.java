...
public class TFAnnotationValue extends org.apache.thrift.TUnion<TFAnnotationValue, TFAnnotationValue._Fields> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFAnnotationValue");
  ...
  static {
    ...
    tmpMap.put(_Fields.INT_STRING_VALUE, new org.apache.thrift.meta_data.FieldMetaData("intStringValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFIntStringValue.class)));
    tmpMap.put(_Fields.INT_STRING_STRING_VALUE, new org.apache.thrift.meta_data.FieldMetaData("intStringStringValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFIntStringStringValue.class)));
    tmpMap.put(_Fields.LONG_INT_INT_BYTE_BYTE_STRING_VALUE, new org.apache.thrift.meta_data.FieldMetaData("longIntIntByteByteStringValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFLongIntIntByteByteStringValue.class)));
    tmpMap.put(_Fields.INT_BOOLEAN_INT_BOOLEAN_VALUE, new org.apache.thrift.meta_data.FieldMetaData("intBooleanIntBooleanValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFIntBooleanIntBooleanValue.class)));
    tmpMap.put(_Fields.STRING_STRING_VALUE, new org.apache.thrift.meta_data.FieldMetaData("stringStringValue", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFStringStringValue.class)));
    metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFAnnotationValue.class, metaDataMap);
  }

  public TFAnnotationValue() {
    super();
  }

  public TFAnnotationValue(_Fields setField, java.lang.Object value) {
    super(setField, value);
  }

  public TFAnnotationValue(TFAnnotationValue other) {
    super(other);
  }
  public TFAnnotationValue deepCopy() {
    return new TFAnnotationValue(this);
  }

  public static TFAnnotationValue stringValue(java.lang.String value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setStringValue(value);
    return x;
  }

  public static TFAnnotationValue boolValue(boolean value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setBoolValue(value);
    return x;
  }

  public static TFAnnotationValue intValue(int value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setIntValue(value);
    return x;
  }

  public static TFAnnotationValue longValue(long value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setLongValue(value);
    return x;
  }

  public static TFAnnotationValue shortValue(short value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setShortValue(value);
    return x;
  }

  public static TFAnnotationValue doubleValue(double value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setDoubleValue(value);
    return x;
  }

  public static TFAnnotationValue binaryValue(java.nio.ByteBuffer value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setBinaryValue(value);
    return x;
  }

  public static TFAnnotationValue binaryValue(byte[] value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setBinaryValue(java.nio.ByteBuffer.wrap(value.clone()));
    return x;
  }

  public static TFAnnotationValue byteValue(byte value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setByteValue(value);
    return x;
  }

  public static TFAnnotationValue intStringValue(TFIntStringValue value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setIntStringValue(value);
    return x;
  }

  public static TFAnnotationValue intStringStringValue(TFIntStringStringValue value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setIntStringStringValue(value);
    return x;
  }

  public static TFAnnotationValue longIntIntByteByteStringValue(TFLongIntIntByteByteStringValue value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setLongIntIntByteByteStringValue(value);
    return x;
  }

  public static TFAnnotationValue intBooleanIntBooleanValue(TFIntBooleanIntBooleanValue value) {
    TFAnnotationValue x = new TFAnnotationValue();
    x.setIntBooleanIntBooleanValue(value);
    return x;
  }

  public static TFAnnotationValue stringStringValue(TFStringStringValue value) {
    TFAnnotationValue x = new TFAnnotationValue();
  ...
  protected void checkType(_Fields setField, java.lang.Object value) throws java.lang.ClassCastException {
    switch (setField) {
      ...
      case INT_STRING_VALUE:
        if (value instanceof TFIntStringValue) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TFIntStringValue for field 'intStringValue', but got " + value.getClass().getSimpleName());
      case INT_STRING_STRING_VALUE:
        if (value instanceof TFIntStringStringValue) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TFIntStringStringValue for field 'intStringStringValue', but got " + value.getClass().getSimpleName());
      case LONG_INT_INT_BYTE_BYTE_STRING_VALUE:
        if (value instanceof TFLongIntIntByteByteStringValue) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TFLongIntIntByteByteStringValue for field 'longIntIntByteByteStringValue', but got " + value.getClass().getSimpleName());
      case INT_BOOLEAN_INT_BOOLEAN_VALUE:
        if (value instanceof TFIntBooleanIntBooleanValue) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TFIntBooleanIntBooleanValue for field 'intBooleanIntBooleanValue', but got " + value.getClass().getSimpleName());
      case STRING_STRING_VALUE:
        if (value instanceof TFStringStringValue) {
          break;
        }
        throw new java.lang.ClassCastException("Was expecting value of type TFStringStringValue for field 'stringStringValue', but got " + value.getClass().getSimpleName());
      default:
      ...
      switch (setField) {
        ...
        case INT_STRING_VALUE:
          if (field.type == INT_STRING_VALUE_FIELD_DESC.type) {
            TFIntStringValue intStringValue;
            intStringValue = new TFIntStringValue();
        ...
        case INT_STRING_STRING_VALUE:
          if (field.type == INT_STRING_STRING_VALUE_FIELD_DESC.type) {
            TFIntStringStringValue intStringStringValue;
            intStringStringValue = new TFIntStringStringValue();
        ...
        case LONG_INT_INT_BYTE_BYTE_STRING_VALUE:
          if (field.type == LONG_INT_INT_BYTE_BYTE_STRING_VALUE_FIELD_DESC.type) {
            TFLongIntIntByteByteStringValue longIntIntByteByteStringValue;
            longIntIntByteByteStringValue = new TFLongIntIntByteByteStringValue();
        ...
        case INT_BOOLEAN_INT_BOOLEAN_VALUE:
          if (field.type == INT_BOOLEAN_INT_BOOLEAN_VALUE_FIELD_DESC.type) {
            TFIntBooleanIntBooleanValue intBooleanIntBooleanValue;
            intBooleanIntBooleanValue = new TFIntBooleanIntBooleanValue();
        ...
        case STRING_STRING_VALUE:
          if (field.type == STRING_STRING_VALUE_FIELD_DESC.type) {
            TFStringStringValue stringStringValue;
            stringStringValue = new TFStringStringValue();
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case BYTE_VALUE:
        ...
        return;
      case INT_STRING_VALUE:
        TFIntStringValue intStringValue = (TFIntStringValue)value_;
        intStringValue.write(oprot);
        return;
      case INT_STRING_STRING_VALUE:
        TFIntStringStringValue intStringStringValue = (TFIntStringStringValue)value_;
        intStringStringValue.write(oprot);
        return;
      case LONG_INT_INT_BYTE_BYTE_STRING_VALUE:
        TFLongIntIntByteByteStringValue longIntIntByteByteStringValue = (TFLongIntIntByteByteStringValue)value_;
        longIntIntByteByteStringValue.write(oprot);
        return;
      case INT_BOOLEAN_INT_BOOLEAN_VALUE:
        TFIntBooleanIntBooleanValue intBooleanIntBooleanValue = (TFIntBooleanIntBooleanValue)value_;
        intBooleanIntBooleanValue.write(oprot);
        return;
      case STRING_STRING_VALUE:
        TFStringStringValue stringStringValue = (TFStringStringValue)value_;
  ...
  public TFIntStringValue getIntStringValue() {
    if (getSetField() == _Fields.INT_STRING_VALUE) {
      return (TFIntStringValue)getFieldValue();
    } else {
  ...
  public void setIntStringValue(TFIntStringValue value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.INT_STRING_VALUE;
    value_ = value;
  }

  public TFIntStringStringValue getIntStringStringValue() {
    if (getSetField() == _Fields.INT_STRING_STRING_VALUE) {
      return (TFIntStringStringValue)getFieldValue();
    } else {
  ...
  public void setIntStringStringValue(TFIntStringStringValue value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.INT_STRING_STRING_VALUE;
    value_ = value;
  }

  public TFLongIntIntByteByteStringValue getLongIntIntByteByteStringValue() {
    if (getSetField() == _Fields.LONG_INT_INT_BYTE_BYTE_STRING_VALUE) {
      return (TFLongIntIntByteByteStringValue)getFieldValue();
    } else {
  ...
  public void setLongIntIntByteByteStringValue(TFLongIntIntByteByteStringValue value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.LONG_INT_INT_BYTE_BYTE_STRING_VALUE;
    value_ = value;
  }

  public TFIntBooleanIntBooleanValue getIntBooleanIntBooleanValue() {
    if (getSetField() == _Fields.INT_BOOLEAN_INT_BOOLEAN_VALUE) {
      return (TFIntBooleanIntBooleanValue)getFieldValue();
    } else {
  ...
  public void setIntBooleanIntBooleanValue(TFIntBooleanIntBooleanValue value) {
    if (value == null) throw new java.lang.NullPointerException();
    setField_ = _Fields.INT_BOOLEAN_INT_BOOLEAN_VALUE;
    value_ = value;
  }

  public TFStringStringValue getStringStringValue() {
    if (getSetField() == _Fields.STRING_STRING_VALUE) {
      return (TFStringStringValue)getFieldValue();
    } else {
  ...
  public void setStringStringValue(TFStringStringValue value) {
    if (value == null) throw new java.lang.NullPointerException();
  ...
  public boolean equals(java.lang.Object other) {
    if (other instanceof TFAnnotationValue) {
      return equals((TFAnnotationValue)other);
    } else {
      return false;
    }
  }

  public boolean equals(TFAnnotationValue other) {
    return other != null && getSetField() == other.getSetField() && getFieldValue().equals(other.getFieldValue());
  }

  @Override
  public int compareTo(TFAnnotationValue other) {
