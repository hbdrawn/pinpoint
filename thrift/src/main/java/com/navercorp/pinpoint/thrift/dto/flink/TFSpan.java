...
public class TFSpan implements org.apache.thrift.TBase<TFSpan, TFSpan._Fields>, java.io.Serializable, Cloneable, Comparable<TFSpan> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFSpan");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFSpanStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFSpanTupleSchemeFactory();
  ...
  private java.util.List<TFAnnotation> annotations; // optional
  private short flag; // optional
  private int err; // optional
  private java.util.List<TFSpanEvent> spanEventList; // optional
  ...
  private TFIntStringValue exceptionInfo; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.ANNOTATIONS, new org.apache.thrift.meta_data.FieldMetaData("annotations", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRUCT            , "TFAnnotation"))));
    ...
    tmpMap.put(_Fields.SPAN_EVENT_LIST, new org.apache.thrift.meta_data.FieldMetaData("spanEventList", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TFSpanEvent.class))));
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFSpan.class, metaDataMap);
  }
  ...
  public TFSpan(TFSpan other) {
    ...
    if (other.isSetAnnotations()) {
      java.util.List<TFAnnotation> __this__annotations = new java.util.ArrayList<TFAnnotation>(other.annotations.size());
      for (TFAnnotation other_element : other.annotations) {
    ...
    if (other.isSetSpanEventList()) {
      java.util.List<TFSpanEvent> __this__spanEventList = new java.util.ArrayList<TFSpanEvent>(other.spanEventList.size());
      for (TFSpanEvent other_element : other.spanEventList) {
        __this__spanEventList.add(new TFSpanEvent(other_element));
      }
    ...
    if (other.isSetExceptionInfo()) {
      this.exceptionInfo = new TFIntStringValue(other.exceptionInfo);
    }
  ...
  public TFSpan deepCopy() {
    return new TFSpan(this);
  }
  ...
  public java.util.Iterator<TFAnnotation> getAnnotationsIterator() {
    return (this.annotations == null) ? null : this.annotations.iterator();
  }

  public void addToAnnotations(TFAnnotation elem) {
    if (this.annotations == null) {
      this.annotations = new java.util.ArrayList<TFAnnotation>();
    }
    this.annotations.add(elem);
  }

  public java.util.List<TFAnnotation> getAnnotations() {
    return this.annotations;
  }

  public void setAnnotations(java.util.List<TFAnnotation> annotations) {
  ...
  public java.util.Iterator<TFSpanEvent> getSpanEventListIterator() {
    return (this.spanEventList == null) ? null : this.spanEventList.iterator();
  }

  public void addToSpanEventList(TFSpanEvent elem) {
    if (this.spanEventList == null) {
      this.spanEventList = new java.util.ArrayList<TFSpanEvent>();
    }
    this.spanEventList.add(elem);
  }

  public java.util.List<TFSpanEvent> getSpanEventList() {
    return this.spanEventList;
  }

  public void setSpanEventList(java.util.List<TFSpanEvent> spanEventList) {
  ...
  public TFIntStringValue getExceptionInfo() {
    return this.exceptionInfo;
  }

  public void setExceptionInfo(TFIntStringValue exceptionInfo) {
  ...
  public void setFieldValue(_Fields field, java.lang.Object value) {
    ...
    case ANNOTATIONS:
      if (value == null) {
        ...
        setAnnotations((java.util.List<TFAnnotation>)value);
      }
      break;
    ...
    case SPAN_EVENT_LIST:
      if (value == null) {
        ...
        setSpanEventList((java.util.List<TFSpanEvent>)value);
      }
      break;
    ...
    case EXCEPTION_INFO:
      if (value == null) {
        ...
        setExceptionInfo((TFIntStringValue)value);
      }
      break;
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFSpan)
      return this.equals((TFSpan)that);
    return false;
  }

  public boolean equals(TFSpan that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFSpan other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFSpan(");
    boolean first = true;
  ...
  private static class TFSpanStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanStandardScheme getScheme() {
      return new TFSpanStandardScheme();
    }
  }

  private static class TFSpanStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFSpan> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFSpan struct) throws org.apache.thrift.TException {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.annotations = new java.util.ArrayList<TFAnnotation>(_list56.size);
                TFAnnotation _elem57;
                for (int _i58 = 0; _i58 < _list56.size; ++_i58)
                {
                  _elem57 = new TFAnnotation();
                  _elem57.read(iprot);
                  struct.annotations.add(_elem57);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spanEventList = new java.util.ArrayList<TFSpanEvent>(_list59.size);
                TFSpanEvent _elem60;
                for (int _i61 = 0; _i61 < _list59.size; ++_i61)
                {
                  _elem60 = new TFSpanEvent();
                  _elem60.read(iprot);
                  struct.spanEventList.add(_elem60);
                }
                iprot.readListEnd();
              }
          ...
          case 26: // EXCEPTION_INFO
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.exceptionInfo = new TFIntStringValue();
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFSpan struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.annotations != null) {
        if (struct.isSetAnnotations()) {
          oprot.writeFieldBegin(ANNOTATIONS_FIELD_DESC);
          {
            ...
            for (TFAnnotation _iter62 : struct.annotations)
            {
              _iter62.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.spanEventList != null) {
        if (struct.isSetSpanEventList()) {
          oprot.writeFieldBegin(SPAN_EVENT_LIST_FIELD_DESC);
          {
            ...
            for (TFSpanEvent _iter63 : struct.spanEventList)
            {
              _iter63.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TFSpanTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanTupleScheme getScheme() {
      return new TFSpanTupleScheme();
    }
  }

  private static class TFSpanTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFSpan> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFSpan struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAnnotations()) {
        {
          ...
          for (TFAnnotation _iter64 : struct.annotations)
          {
            _iter64.write(oprot);
          }
        }
      ...
      if (struct.isSetSpanEventList()) {
        {
          ...
          for (TFSpanEvent _iter65 : struct.spanEventList)
          {
            _iter65.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFSpan struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(12)) {
        {
          ...
          struct.annotations = new java.util.ArrayList<TFAnnotation>(_list66.size);
          TFAnnotation _elem67;
          for (int _i68 = 0; _i68 < _list66.size; ++_i68)
          {
            _elem67 = new TFAnnotation();
            _elem67.read(iprot);
            struct.annotations.add(_elem67);
          }
        }
        struct.setAnnotationsIsSet(true);
      }
      ...
      if (incoming.get(15)) {
        {
          ...
          struct.spanEventList = new java.util.ArrayList<TFSpanEvent>(_list69.size);
          TFSpanEvent _elem70;
          for (int _i71 = 0; _i71 < _list69.size; ++_i71)
          {
            _elem70 = new TFSpanEvent();
            _elem70.read(iprot);
            struct.spanEventList.add(_elem70);
          }
        }
        struct.setSpanEventListIsSet(true);
      }
