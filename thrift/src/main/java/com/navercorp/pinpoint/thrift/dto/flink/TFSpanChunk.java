...
public class TFSpanChunk implements org.apache.thrift.TBase<TFSpanChunk, TFSpanChunk._Fields>, java.io.Serializable, Cloneable, Comparable<TFSpanChunk> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFSpanChunk");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFSpanChunkStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFSpanChunkTupleSchemeFactory();
  ...
  private java.util.List<TFSpanEvent> spanEventList; // required
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFSpanChunk.class, metaDataMap);
  }
  ...
  public TFSpanChunk(
    ...
    long spanId,
    java.util.List<TFSpanEvent> spanEventList)
  {
    this();
   ...
   */
  public TFSpanChunk(TFSpanChunk other) {
  ...
  public TFSpanChunk deepCopy() {
    return new TFSpanChunk(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFSpanChunk)
      return this.equals((TFSpanChunk)that);
    return false;
  }

  public boolean equals(TFSpanChunk that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFSpanChunk other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFSpanChunk(");
    boolean first = true;
  ...
  private static class TFSpanChunkStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanChunkStandardScheme getScheme() {
      return new TFSpanChunkStandardScheme();
    }
  }

  private static class TFSpanChunkStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFSpanChunk> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFSpanChunk struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.spanEventList = new java.util.ArrayList<TFSpanEvent>(_list72.size);
                TFSpanEvent _elem73;
                for (int _i74 = 0; _i74 < _list72.size; ++_i74)
                {
                  _elem73 = new TFSpanEvent();
                  _elem73.read(iprot);
                  struct.spanEventList.add(_elem73);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFSpanChunk struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.spanEventList != null) {
        oprot.writeFieldBegin(SPAN_EVENT_LIST_FIELD_DESC);
        {
          ...
          for (TFSpanEvent _iter75 : struct.spanEventList)
          {
            _iter75.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TFSpanChunkTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanChunkTupleScheme getScheme() {
      return new TFSpanChunkTupleScheme();
    }
  }

  private static class TFSpanChunkTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFSpanChunk> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFSpanChunk struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetSpanEventList()) {
        {
          ...
          for (TFSpanEvent _iter76 : struct.spanEventList)
          {
            _iter76.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFSpanChunk struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.spanEventList = new java.util.ArrayList<TFSpanEvent>(_list77.size);
          TFSpanEvent _elem78;
          for (int _i79 = 0; _i79 < _list77.size; ++_i79)
          {
            _elem78 = new TFSpanEvent();
            _elem78.read(iprot);
            struct.spanEventList.add(_elem78);
          }
        }
        struct.setSpanEventListIsSet(true);
      }
