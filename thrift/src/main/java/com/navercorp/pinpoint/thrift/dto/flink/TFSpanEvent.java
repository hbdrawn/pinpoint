...
public class TFSpanEvent implements org.apache.thrift.TBase<TFSpanEvent, TFSpanEvent._Fields>, java.io.Serializable, Cloneable, Comparable<TFSpanEvent> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TFSpanEvent");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new TFSpanEventStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new TFSpanEventTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TFSpanEvent.class, metaDataMap);
  }
   ...
   */
  public TFSpanEvent(TFSpanEvent other) {
  ...
  public TFSpanEvent deepCopy() {
    return new TFSpanEvent(this);
  }
  ...
  public boolean equals(java.lang.Object that) {
    if (that == null)
      return false;
    if (that instanceof TFSpanEvent)
      return this.equals((TFSpanEvent)that);
    return false;
  }

  public boolean equals(TFSpanEvent that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(TFSpanEvent other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TFSpanEvent(");
    boolean first = true;
  ...
  private static class TFSpanEventStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanEventStandardScheme getScheme() {
      return new TFSpanEventStandardScheme();
    }
  }

  private static class TFSpanEventStandardScheme extends org.apache.thrift.scheme.StandardScheme<TFSpanEvent> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TFSpanEvent struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.annotations = new java.util.ArrayList<TFAnnotation>(_list48.size);
                TFAnnotation _elem49;
                for (int _i50 = 0; _i50 < _list48.size; ++_i50)
                {
                  _elem49 = new TFAnnotation();
                  _elem49.read(iprot);
                  struct.annotations.add(_elem49);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TFSpanEvent struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.annotations != null) {
        if (struct.isSetAnnotations()) {
          oprot.writeFieldBegin(ANNOTATIONS_FIELD_DESC);
          {
            ...
            for (TFAnnotation _iter51 : struct.annotations)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
  ...
  private static class TFSpanEventTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    public TFSpanEventTupleScheme getScheme() {
      return new TFSpanEventTupleScheme();
    }
  }

  private static class TFSpanEventTupleScheme extends org.apache.thrift.scheme.TupleScheme<TFSpanEvent> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TFSpanEvent struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetAnnotations()) {
        {
          ...
          for (TFAnnotation _iter52 : struct.annotations)
          {
            _iter52.write(oprot);
          }
        }
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TFSpanEvent struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.annotations = new java.util.ArrayList<TFAnnotation>(_list53.size);
          TFAnnotation _elem54;
          for (int _i55 = 0; _i55 < _list53.size; ++_i55)
          {
            _elem54 = new TFAnnotation();
            _elem54.read(iprot);
            struct.annotations.add(_elem54);
          }
        }
        struct.setAnnotationsIsSet(true);
      }
